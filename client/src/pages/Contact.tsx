    ...
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-[#F5F1ED] to-[#E6DDD5] rounded-2xl p-12">
                <div className="space-y-8">
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg h-96">
                <iframe
                  ...
                  title="Jain Enterprises Location"
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <button className="bg-[#25D366] hover:bg-[#20BA5A] text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center gap-2 mx-auto">
