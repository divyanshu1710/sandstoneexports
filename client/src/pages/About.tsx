    ...
    <div className="pt-20">
      ...
      >
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="font-serif text-5xl md:text-6xl font-bold mb-4" data-testid="text-about-hero-title">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-semibold mb-6" data-testid="text-story-heading">
              Our Story
            </h2>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-[#F5F1ED] to-[#E6DDD5]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-semibold mb-6" data-testid="text-values-heading">
              What Drives Us
            </h2>
            <div className="w-20 h-0.5 bg-primary mx-auto" />
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-semibold mb-6" data-testid="text-facilities-heading">
            ...
            <div className="relative h-80 rounded-xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <p className="text-white font-semibold" data-testid="text-gallery-caption-1">
                  Precision stone cutting machinery
                </p>
              </div>
            </div>
